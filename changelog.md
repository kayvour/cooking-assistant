...
## [1.1.1] – 2026-03-01
### Changed
- Removed background image (`bg.jpg`) in favour of solid colours — off-white (`#f5f5f0`) in light mode and near-black (`#1a1a1a`) in dark mode.
- Theme preference now persisted via `localStorage`, fixing resets on page reload and navigation.
---
## [1.1.0] – 2025-06-18
### Added
